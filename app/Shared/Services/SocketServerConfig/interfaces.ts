...
export type SocketStartOptions = {
    onComplete?: (metadata: Metadata) => Promise<void> | void
    onConnected?: (socket: SocketIo, metadata: Metadata) => Promise<void> | void
}
export type SocketRequest = { body: any; event: string; [x: string]: any }
export type SocketConnection = {
    socket: SocketIo
    io: Server
    response: <R extends object = {}>(arg: R) => void
}
...
export type SocketInstanceMiddleware = {
    new (...args: any[]): SocketMiddleware
}
